...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-57dd62db", Component.options)
  } else {
    hotAPI.reload("data-v-57dd62db", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  config: {
    ...
    window: {
      navigationBarBackgroundColor: '#1D3F59',
      navigationBarTitleText: '币知圈',
